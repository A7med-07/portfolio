    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="text-2xl font-bold gradient-text mb-4">Ahmed Sabry</h3>
            <p className="text-gray-400 mb-4">
              Frontend Developer specializing in building Wepsites.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} <span className="hover:text-primary-400 cursor-pointer">Ahmed Sabry</span>. All rights reserved.
          </p>
